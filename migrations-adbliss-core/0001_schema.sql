...
-- ============================================================================
-- Flow Builder tables removed — the tag's aggregate flow graph IS the funnel.
-- Conversion criteria live in platform_connections.settings JSON.
-- See docs/ATTRIBUTION_SYSTEM.md for the full attribution architecture.
-- ============================================================================
...
CREATE TABLE ai_optimization_settings (
  ...
  run_frequency TEXT NOT NULL DEFAULT 'weekly' CHECK(run_frequency IN ('weekly', 'daily', 'twice_daily')),
