...
-- Tables: support_tickets, support_customers, support_conversations, support_messages
...
CREATE INDEX idx_support_messages_conversation ON support_messages(organization_id, conversation_ref);
