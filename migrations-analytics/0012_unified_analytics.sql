...
-- Tables: analytics_sessions, analytics_users, analytics_events, analytics_page_views
...
CREATE INDEX idx_analytics_page_views_date ON analytics_page_views(organization_id, viewed_at);
CREATE INDEX idx_analytics_page_views_org ON analytics_page_views(organization_id, source_platform);
