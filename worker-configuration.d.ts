/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03538629dbe3d8c9f59a58c6ca1291c1)
// Runtime types generated with workerd@1.20260219.0 2025-12-30 nodejs_compat
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		GOOGLE_ADS_DEVELOPER_TOKEN: SecretsStoreSecret;
		FACEBOOK_APP_ID: SecretsStoreSecret;
		FACEBOOK_APP_SECRET: SecretsStoreSecret;
	...
	interface StagingEnv {
		...
		IRIS_BASE_URL: string;
		EMAIL_DRY_RUN: string;
		CLEARLIFT_CRON: Fetcher /* clearlift-queue-consumer-staging */;
		ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/index").AnalysisWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		ENCRYPTION_KEY: string;
		...
		SYNC_QUEUE: Queue;
		CLOUDFLARE_ACCOUNT_ID: "133c285e1182ce57a619c802eaf56fb0";
		R2_BUCKET_NAME: "clearlift-db" | "clearlift-db-staging";
		...
		HUBSPOT_CLIENT_SECRET?: SecretsStoreSecret;
		ANALYTICS?: AnalyticsEngineDataset;
		CLEARLIFT_CRON?: Fetcher /* clearlift-queue-consumer-staging */ | Fetcher /* clearlift-queue-consumer */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_SQL_TABLE" | "USE_D1_ANALYTICS" | "ENCRYPTION_KEY" | "R2_SQL_TOKEN" | "FACEBOOK_APP_ID" | "FACEBOOK_APP_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_ADS_DEVELOPER_TOKEN" | "SENDGRID_API_KEY" | "ANTHROPIC_API_KEY" | "GEMINI_API_KEY" | "OAUTH_CALLBACK_BASE" | "APP_BASE_URL" | "CDN_BASE_URL" | "IRIS_BASE_URL" | "EMAIL_DRY_RUN">> {}
}
